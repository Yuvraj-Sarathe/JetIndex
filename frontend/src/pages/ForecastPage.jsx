  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        {data && (
          <span className="text-xs font-mono px-3 py-1 rounded-full bg-card border border-hairline text-primary">
        ...
        <>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div className="bg-card border border-hairline rounded-xl p-4">
              ...
              <p className="text-3xl font-bold text-primary font-mono tabular-nums">{data.mean_forecast}</p>
            ...
            <div className="bg-card border border-hairline rounded-xl p-4">
              ...
              <p className="text-3xl font-bold text-accent-rose font-mono tabular-nums">{data.net_transport_bps} bps</p>
