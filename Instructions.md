...
API ENDPOINTS  
  [ ] Wire MOCK_MODE toggle in all 9 endpoints
...
TEAM COORDINATION
  [ ] Tell Vanshika: expose run_pipeline() as function
  [ ] Tell Vanshika: implement loader.load() using db.queries
  [ ] Tell Sourabh/Abhay: fill build_request/parse_ok after recon
  [ ] Tell Sourabh/Abhay: wire engine to db/queries.py
  [ ] Tell Sneh: start docs/architecture.md and index_methodology.md
